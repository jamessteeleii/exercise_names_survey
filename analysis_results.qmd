...
The majority of respondents recognised the exercises displayed with all >90% recognition except for the four Vitruvian machine exercises (~62% to 67%). The percentage of respondents who did and did not (excluding non-responses) recognise each exercise is shown in @tbl-recognise.
